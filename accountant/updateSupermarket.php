                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active text-white" id="cyberViewTab" data-bs-toggle="tab"
                                href="#cyberView"><i class="fas fa-eye"></i>View Cyber</a>
                        </li>
                        <li class="nav-item">
                                ...
                                <form method="POST">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" value="<?php echo $row['product_name'] ?>"
                                            id="productNameSupermarket" name="productNameSupermarket" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="unitPriceCyber" class="form-label">Unit Price in RWF</label>
                                        <input type="number" class="form-control" value="<?php echo $row['unit_price'] ?>"
                                            id="unitPriceSupermarket" name="unitPriceSupermarket" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="quantityCyber" class="form-label">Quantity</label>
                                        <input type="number" class="form-control" value="<?php echo $row['quantity'] ?>"
                                            id="quantitySupermarket" name="quantitySupermarket" required>
                                    </div>
                                    <button type="submit" name="updateSupermarketProduct" class="btn btn-primary">Update
                                        Product</button>
                                </form>
                            </div>
                        <?php } ?>
