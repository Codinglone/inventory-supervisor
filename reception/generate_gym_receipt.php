...
if ($transactionId) {
    ...
    $query = "SELECT * FROM gym_clients WHERE id = $transactionId";
    ...
    if ($result) {
        ...
        $receiptHTML = "
            ...
            <body>
                ...
                <p><strong>Service Type:</strong> Gym</p>
                <p><strong>Membership Type:</strong> {$transactionData['membership_type']}</p>
                <p><strong>Organization:</strong> {$transactionData['organization']}</p>
                <p><strong>Date:</strong> {$transactionData['dates']}</p>
                <br>
                <br>
