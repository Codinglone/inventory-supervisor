...
if ($transactionId) {
    ...
    $query = "SELECT * FROM restaurent_products_transactions WHERE id = $transactionId";
    $result = mysqli_query($link, $query);

    if ($result) {
        $transactionData = mysqli_fetch_assoc($result);
        $total = $transactionData['price'] * $transactionData['quantity'];
        ...
        $receiptHTML = "
            ...
            <body>
                ...
                <p><strong>Unit Price in RWF:</strong> {$transactionData['price']}</p>
